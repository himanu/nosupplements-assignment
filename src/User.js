...
const User = ({ user, handleDelete, editUser }) => {
  ...
  return (
    <div className="user">
      ...
      <div className="footer">
        <Heart />
        <Edit onEditIcon={() => setHideModal(!hideModal)} />
        <Delete onDelete={() => handleDelete(user.id)} />
      </div>
      <EditModal hide={hideModal} user={user} onEdit={editUser} shuffleEditModal={()=>{
